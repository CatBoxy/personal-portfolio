        ...
        <div className="flex flex-col justify-center items-start w-full max-w-2xl border-gray-200 dark:border-gray-700 mx-auto pb-16">
          <div className="flex flex-col items-start w-full justify-between">
            ...
            <p className="text-justify mb-8 text-gray-600 dark:text-gray-400">
              Proyecto realizado para el Basement Challenge. Consiste en un
              marketplace de productos de ropa con carrito de compras. El
              principal objetivo fue familiarizarse con ReactJS, chakra-UI y
              React hooks.
            </p>
            <ul className=" mb-8 px-4 w-full">
              <li className="mb-2">
                ...
                <a
                  href="https://basement-challenge-react.herokuapp.com/"
                  target="_blank"
                  rel="noreferrer"
              ...
              <li className="flex ">
                ...
                <a
                  ...
                  href="https://github.com/CatBoxy/basement_challenge_UI"
                  target="_blank"
                  rel="noreferrer"
                >
