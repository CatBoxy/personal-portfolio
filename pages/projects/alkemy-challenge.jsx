        ...
        <div className="flex flex-col justify-center items-start w-full max-w-2xl border-gray-200 dark:border-gray-700 mx-auto pb-16">
          <div className="flex flex-col items-start w-full justify-between">
            ...
            <p className="text-justify mb-8 text-gray-600 dark:text-gray-400">
              Proyecto realizado para el Alkemy Challenge. Consiste en una carta
              de platos para el armado de un menú personalizado. Cada plato y
              menú final muestra diferentes atributos al usuario. La app posee
              un Login obligatorio para acceder al contenido, además la
              autenticación se realiza con una API provista por Alkemy. La app
              está integrada con la API de{' '}
              <a
            ...
            <p className="text-justify text-gray-600 dark:text-gray-400">
              <span className="font-bold dark:text-white">Importante:</span> Es
              necesario habilitar el contenido no seguro en el navegador para
              permitir la petición HTTP de la API de Alkemy.
            </p>
            <ul className="mt-8 mb-8 px-4 w-full">
              <li className="mb-2">
                ...
                <a
                  href="https://alkemy-react-js-challenge.vercel.app/"
                  target="_blank"
                  rel="noreferrer"
              ...
              <li className="mb-2">
                ...
                <p className="inline-block text-gray-600 dark:text-gray-400">
                  {' '}
                  ReactJS, Vite, Bootstrap, Styled-components, React-router
                </p>
              </li>
              <li className="flex ">
                ...
                <a
                  ...
                  href="https://github.com/CatBoxy/Alkemy_ReactJS_Challenge"
                  target="_blank"
                  rel="noreferrer"
                >
