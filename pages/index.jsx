        ...
        <div className="flex flex-col justify-center items-start w-full max-w-2xl border-gray-200 dark:border-gray-700 mx-auto pb-16">
          ...
          <Section delay={0.1}>
            ...
            <div className="flex flex-row justify-evenly w-full items-center mb-6 sm:mb-0">
              ...
              <a
                target="_blank"
                rel="noreferrer"
                href="https://drive.google.com/file/d/1VcM2TSIvlXd9L7RY6R7XK6ln8uzzd2Vn/view?usp=sharing"
              >
          ...
          <Section delay={0.2}>
            ...
            <p className="mb-6 text-justify text-gray-600 dark:text-gray-400 ">
              {
                t[
                  'Front End development, UI design, React.js, Vue.js, Python, Web Scraping, DDD.'
                ]
              }
            </p>
          </Section>
            ...
            <ul className="flex flex-col items-start">
              <li>
                <Link href="https://github.com/CatBoxy">
                  <a
                    className="text-gray-600 dark:text-gray-400 flex flex-row ml-[-0.75rem] py-6 px-3 h-8 items-center rounded-lg hover:bg-gray-200 dark:hover:bg-gray-800 transition-all"
                    target="_blank"
                  >
              ...
              <li>
                <Link href="https://twitter.com/JuanCLamb">
                  <a
                    className="text-gray-600 dark:text-gray-400 flex flex-row ml-[-0.75rem] py-6 px-3 h-8 items-center rounded-lg hover:bg-gray-200 dark:hover:bg-gray-800 transition-all"
                    target="_blank"
                  >
